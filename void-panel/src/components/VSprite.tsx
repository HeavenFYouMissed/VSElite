...
export function VSprite({ cell = 8, mode = 'idle', showV = true }: { cell?: number; mode?: SpriteMode; showV?: boolean }) {
	...
	const bob = mode === 'idle' ? Math.round(Math.sin(t / 3)) * cell * 0.18 : mode === 'walk' ? (t % 2 ? cell * 0.18 : 0) : 0
